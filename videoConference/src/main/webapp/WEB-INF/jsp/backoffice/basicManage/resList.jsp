            ...
            <div class="Smain">
                <div class="Swrap Stitle">
                    <div class="infomenuA">
                        ...
                        <span>></span>예약관리 
                        <span>></span><strong>회의실 승인관리</strong>
                    </div>
                </div>
            </div>

            <div class="Swrap Asearch">
                <div class="Atitle">총 <span>${totalCnt}</span>건의 예약정보가 있습니다.</div>
                       ...
                       <c:forEach items="${resultList}" var="resInfo" varStatus="status">
                        <tr>
							...
							<td>${resInfo.seatName }</td>
					   		...
					   		<td><a href="javascript:fn_resinfo('${resInfo.resSeq }')">${resInfo.resTitle }</a></td>
...
<script src="/js/jquery-ui.js"></script>
 ...
 <script type="text/javascript">
    ...
    function fn_resinfo(code){
    	var url ="/backoffice/popup/resInfo.do?resSeq="+code;		
		NewWindow(url, "예약변경", "800", "600", "no");
    }
