...
<body>
<form:form name="regist" commandName="regist" method="post" action="/backoffice/resManage/report03.do">
                            ...
                            <tbody>
                             <c:forEach items="${resultList }" var="reportinfo" varStatus="status">
                                <tr>
                                    ...
                                    <td>${reportinfo.workCnt }</td>
                                    <td>${reportinfo.meetingCnt}</td>
                                </tr>
                              </c:forEach>                              
                            </tbody>
                        </table>
...
<c:import url="/backoffice/inc/bottom_inc.do" /> 
 ...
 <script type="text/javascript">
    ...
    function excel_down(){    	
    	$("form[name=regist]").attr("action", "/backoffice/res/resReportListExcel03.do").submit();
    }    
