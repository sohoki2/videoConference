...
<body>
<form:form name="regist" commandName="regist" method="post" action="/backoffice/resManage/report01.do">
                ...
                <div class="Smain">
                    <div class="Swrap Stitle">
                        <div class="infomenuA">
                            ...
                            <strong>
                            <c:choose>
			                   <c:when test="${regist.reportGubun eq '01'}">워크룸통계</c:when>
		                       <c:otherwise>회의실통계</c:otherwise>
		                     </c:choose>
                            ...
                            <tbody>
                             <c:forEach items="${resultList }" var="reportinfo" varStatus="status">
                                <tr>
                                    ...
                                    <td>${reportinfo.totalSeat }(${reportinfo.resCount })</td>
                                    <td>${reportinfo.roomInCount}</td>
                                    <td>${reportinfo.per}%</td>
                                    <td>${reportinfo.resCancel}</td>
                                    <td>${reportinfo.per1}%</td>
                                    <td>${reportinfo.remindSeat}</td>
                                </tr>
                              </c:forEach>                              
                            </tbody>
                        </table>
