...
<body>
<form:form name="regist" commandName="regist" method="post" action="/backoffice/resManage/report04.do">
...
<c:import url="/backoffice/inc/bottom_inc.do" /> 
 ...
 <script type="text/javascript">
    ...
    function excel_down(){    	
    	$("form[name=regist]").attr("action", "/backoffice/res/resReportListExcel04.do").submit();
    }    
