...
public class EgovUserDetailsHelper {
		...
		public static Object getAuthenticatedUser() {
			...
			return (AdminLoginVO)RequestContextHolder.getRequestAttributes().getAttribute("AdminLoginVO", RequestAttributes.SCOPE_SESSION)==null ? 
					new AdminLoginVO() : (AdminLoginVO) RequestContextHolder.getRequestAttributes().getAttribute("AdminLoginVO", RequestAttributes.SCOPE_SESSION);
